...
@connect((state, props) => ({ config: state.config, houseCheckSearchResult: state.houseCheckSearchResult }))
export default class detail extends Component {
  ...
  _handleSubmit() {
    this.props.dispatch(fetchHouseCheckList({ keyword: this.props.form.getFieldValue('keyword') }));
  }
